#ifndef __CHOLESKY_TEST_CUH__
#define __CHOLESKY_TEST_CUH__
...
#include "cholesky-sparse.h"
#include "cholesky-parallel.h"
#include "cholmod.h"
//#include "test/tree-tests.h"

int cholesky(int argc, char **argv) {
	std::string filename = "./src/test/matrices/LFAT5.rb";
